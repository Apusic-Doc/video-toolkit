...
export const STRINGS = {
  zh: {
    nav_features: '功能点', nav_groups: '分组', nav_settings: '设置',
    ...
    confirm_delete_feature: (name) => `删除 feature「${name}」？会移进 _trash/ 子目录，不会真的清空，可以手动找回。`,
  ...
  en: {
    nav_features: 'Features', nav_groups: 'Groups', nav_settings: 'Settings',
    ...
    confirm_delete_feature: (name) => `Delete feature "${name}"? It moves into _trash/, not permanently erased — can be restored by hand.`,
